...
export function Environment(name: string): BaseURL {
  return `https://${name}-my-app-name-x8c2.encr.app`;
}
...
/**
 * Client is an API client for the my-app-name-x8c2 Encore application.
 */
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] =
        "my-app-name-x8c2-Generated-TS-Client (Encore/v1.46.5)";
    }
